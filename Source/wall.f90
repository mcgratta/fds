         ...
         IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
            SELECT CASE(BC%IOR)
               CASE( 1)
                  ...
                  ZZ_GET_OTHER(1:N_TRACKED_SPECIES) = ZZP(BC%IIG-2,BC%JJG,BC%KKG,1:N_TRACKED_SPECIES)
               CASE(-1)
                  ZZ_GET(1:N_TRACKED_SPECIES)       = ZZP(BC%IIG-1,BC%JJG,BC%KKG,1:N_TRACKED_SPECIES)
                  ZZ_GET_OTHER(1:N_TRACKED_SPECIES) = ZZP(BC%IIG+2,BC%JJG,BC%KKG,1:N_TRACKED_SPECIES)
               CASE( 2)
                  ZZ_GET(1:N_TRACKED_SPECIES)       = ZZP(BC%IIG,BC%JJG+1,BC%KKG,1:N_TRACKED_SPECIES)
                  ZZ_GET_OTHER(1:N_TRACKED_SPECIES) = ZZP(BC%IIG,BC%JJG-2,BC%KKG,1:N_TRACKED_SPECIES)
               CASE(-2)
                  ZZ_GET(1:N_TRACKED_SPECIES)       = ZZP(BC%IIG,BC%JJG-1,BC%KKG,1:N_TRACKED_SPECIES)
                  ZZ_GET_OTHER(1:N_TRACKED_SPECIES) = ZZP(BC%IIG,BC%JJG+2,BC%KKG,1:N_TRACKED_SPECIES)
               CASE( 3)
                  ZZ_GET(1:N_TRACKED_SPECIES)       = ZZP(BC%IIG,BC%JJG,BC%KKG+1,1:N_TRACKED_SPECIES)
                  ZZ_GET_OTHER(1:N_TRACKED_SPECIES) = ZZP(BC%IIG,BC%JJG,BC%KKG-2,1:N_TRACKED_SPECIES)
               CASE(-3)
                  ZZ_GET(1:N_TRACKED_SPECIES)       = ZZP(BC%IIG,BC%JJG,BC%KKG-1,1:N_TRACKED_SPECIES)
                  ZZ_GET_OTHER(1:N_TRACKED_SPECIES) = ZZP(BC%IIG,BC%JJG,BC%KKG+2,1:N_TRACKED_SPECIES)
            END SELECT
      ...
      SELECT CASE(BC%IOR)
         CASE( 1)
            IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
               ...
               RHO_OTHER_2 = RHOP(BC%IIG-2,BC%JJG,BC%KKG)
            ENDIF
         ...
         CASE( 2)
            IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
               ...
               RHO_OTHER_2 = RHOP(BC%IIG,BC%JJG-2,BC%KKG)
            ENDIF
         ...
         CASE( 3)
            IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
               ...
               RHO_OTHER_2 = RHOP(BC%IIG,BC%JJG,BC%KKG-2)
            ENDIF
            ...
            SELECT CASE(BC%IOR)
               CASE( 1)
                  IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
                     ...
                     RHO_ZZ_OTHER_2 = RHOP(BC%IIG-2,BC%JJG,BC%KKG)*ZZP(BC%IIG-2,BC%JJG,BC%KKG,N)
                  ENDIF
               ...
               CASE( 2)
                  IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
                     ...
                     RHO_ZZ_OTHER_2 = RHOP(BC%IIG,BC%JJG-2,BC%KKG)*ZZP(BC%IIG,BC%JJG-2,BC%KKG,N)
                  ENDIF
               ...
               CASE( 3)
                  IF (SECOND_ORDER_INTERPOLATED_BOUNDARY) THEN
                     ...
                     RHO_ZZ_OTHER_2 = RHOP(BC%IIG,BC%JJG,BC%KKG-2)*ZZP(BC%IIG,BC%JJG,BC%KKG-2,N)
                  ENDIF
                     ...
                     IIO_LOOP: DO IIO=EWC%IIO_MIN,EWC%IIO_MAX
                        ...
                        SELECT CASE(BC%IOR)
                           CASE( 1)
                              ...
                              RHO_D_DZDN = RHO_D*(ZZP(BC%IIG,BC%JJG,BC%KKG,N)-ZZP(BC%IIG-1,BC%JJG,BC%KKG,N))*MM%RDXN(IIO)
                           CASE(-1)
                              ARO = MM%DY(JJO)*MM%DZ(KKO)/(DY(BC%JJ)*DZ(BC%KK))
                              RHO_D_DZDN = RHO_D*(ZZP(BC%IIG,BC%JJG,BC%KKG,N)-ZZP(BC%IIG+1,BC%JJG,BC%KKG,N))*MM%RDXN(IIO-1)
                           CASE( 2)
                              ARO = MM%DX(IIO)*MM%DZ(KKO)/(DX(BC%II)*DZ(BC%KK))
                              RHO_D_DZDN = RHO_D*(ZZP(BC%IIG,BC%JJG,BC%KKG,N)-ZZP(BC%IIG,BC%JJG-1,BC%KKG,N))*MM%RDYN(JJO)
                           CASE(-2)
                              ARO = MM%DX(IIO)*MM%DZ(KKO)/(DX(BC%II)*DZ(BC%KK))
                              RHO_D_DZDN = RHO_D*(ZZP(BC%IIG,BC%JJG,BC%KKG,N)-ZZP(BC%IIG,BC%JJG+1,BC%KKG,N))*MM%RDYN(JJO-1)
                           CASE( 3)
                              ARO = MM%DX(IIO)*MM%DY(JJO)/(DX(BC%II)*DY(BC%JJ))
                              RHO_D_DZDN = RHO_D*(ZZP(BC%IIG,BC%JJG,BC%KKG,N)-ZZP(BC%IIG,BC%JJG,BC%KKG-1,N))*MM%RDZN(KKO)
                           CASE(-3)
                              ARO = MM%DX(IIO)*MM%DY(JJO)/(DX(BC%II)*DY(BC%JJ))
                              RHO_D_DZDN = RHO_D*(ZZP(BC%IIG,BC%JJG,BC%KKG,N)-ZZP(BC%IIG,BC%JJG,BC%KKG+1,N))*MM%RDZN(KKO-1)
                        END SELECT
