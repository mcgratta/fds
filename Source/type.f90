...
TYPE CELL_WEIGHT_TYPE
   INTEGER :: N
   INTEGER, ALLOCATABLE, DIMENSION(:) :: I,J,K
   REAL(EB), ALLOCATABLE, DIMENSION(:) :: WGT
END TYPE CELL_WEIGHT_TYPE


TYPE OMESH_TYPE
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:) :: RHO,RHOS,TMP,U,V,W,US,VS,WS,H,HS,FVX,FVY,FVZ,IL_S,IL_R
   REAL(EB), ALLOCATABLE, DIMENSION(:,:,:,:) :: ZZ,ZZS
   INTEGER, ALLOCATABLE, DIMENSION(:) :: IIO_R,JJO_R,KKO_R,IOR_R,IIO_S,JJO_S,KKO_S,IOR_S
   INTEGER, ALLOCATABLE, DIMENSION(:) :: IIG_R,JJG_R,KKG_R,INT_R,IORE_R,IIG_S,JJG_S,KKG_S,INT_S,IORE_S
   INTEGER :: I_MIN_R=-10,I_MAX_R=-10,J_MIN_R=-10,J_MAX_R=-10,K_MIN_R=-10,K_MAX_R=-10,NIC_R=0,N_EWC_R=0, &
              I_MIN_S=-10,I_MAX_S=-10,J_MIN_S=-10,J_MAX_S=-10,K_MIN_S=-10,K_MAX_S=-10,NIC_S=0,N_EWC_S=0
   INTEGER, DIMENSION(8) :: INTEGER_SEND_BUFFER,INTEGER_RECV_BUFFER
   ...
   TYPE (CELL_WEIGHT_TYPE), ALLOCATABLE, DIMENSION(:,:) :: CELL_WEIGHT
