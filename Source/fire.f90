...
PUBLIC COMBUSTION_LOAD_BALANCED,CONDENSATION_EVAPORATION,GET_FLAME_TEMPERATURE
...
IF (.NOT. COMBUSTION_INIT) THEN
   ...
   NVAR_TO_SEND = N_TRACKED_SPECIES +6 ! NS, TEMP, RHO, PRES, MU, DELTA, VOL
   ...
   DO K=1,KBAR
      DO J=1,JBAR
         DO I=1,IBAR
            ...
            CALL CHECK_CHEMICALLY_ACTIVE_STATE(ZZ_GET, TMP(I,J,K), I, J, K, .FALSE., IS_CHEM_ACTIVE)
   ...
   IF (CC_IBM) THEN
      ...
      DO ICC=1,MESHES(NM)%N_CUTCELL_MESH
         ...
         DO JCC=1,CC%NCELL
            ...
            PRES = PBAR(K,PRESSURE_ZONE(I,J,K)) + RHO(I,J,K)*(H(I,J,K)-KRES(I,J,K))
            CALL CHECK_CHEMICALLY_ACTIVE_STATE(ZZ_GET, CUT_CELL(ICC)%TMP(JCC), I, J, K, .TRUE., IS_CHEM_ACTIVE)
            IF (STOP_STATUS/=NO_STOP) RETURN
            IF (.NOT. IS_CHEM_ACTIVE) CYCLE
            NCHEM_ACTIVE_CELLS_AND_CC = NCHEM_ACTIVE_CELLS_AND_CC + 1
